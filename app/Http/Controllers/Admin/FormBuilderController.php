...
class FormBuilderController extends Controller
{
    ...
    public function store(Request $request, Panel $panel): RedirectResponse
    {
        ...
        return redirect()->route('admin.forms.edit', [$panel, $form])->with('status', __('Form created successfully.'));
    }
    ...
    public function update(Request $request, Panel $panel, FormDefinition $form): RedirectResponse
    {
        ...
        return redirect()->route('admin.forms.edit', [$panel, $form])->with('status', __('Form updated successfully.'));
    }
